...
namespace metallenium_backend.API.Migrations
{
    public partial class newtables2 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "ConfirmedTickets",
                columns: table => new
                {
                    ConfirmedTicketId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TicketId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ConfirmedTickets", x => x.ConfirmedTicketId);
                    table.ForeignKey(
                        name: "FK_ConfirmedTickets_Tickets_TicketId",
                        column: x => x.TicketId,
